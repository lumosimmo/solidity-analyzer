...
![Open VSX Version](https://img.shields.io/open-vsx/v/lumosimmo/solidity-analyzer) ![Visual Studio Marketplace Version](https://img.shields.io/visual-studio-marketplace/v/lumosimmo.solidity-analyzer)
